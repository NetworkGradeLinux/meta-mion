...
do_compile[noexec] = "1"
do_install[mcdepends] = "mc::${GUESTMC}:mion-guest-onlpv2:do_image_complete "
...
do_install () {
    ...
    install ${TOPDIR}/tmp-guest-${MACHINE}-${TCLIBC}/deploy/images/${MACHINE}/mion-guest-onlpv2-${MACHINE}.tar.xz ${D}/usr/share/srunc/local-feed/guest/mion-guest-onlpv2/
}
