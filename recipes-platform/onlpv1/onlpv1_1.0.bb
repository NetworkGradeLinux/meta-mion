...
do_install() {
    ...
    install -m 755 packages/platforms/${ONIE_VENDOR}/${ONL_ARCH}/${ONL_MACHINE}/platform-config/r${ONIE_MACHINE_REV}/src/python/${ONIE_ARCH}_${ONL_VENDOR}_${ONIE_MACHINE}_r${ONIE_MACHINE_REV}/__init__.py ${D}/${libdir}/python${PYTHON_MAJMIN}/onl/platform/${ONIE_ARCH}_${ONIE_VENDOR}_${ONIE_MACHINE}_r${ONIE_MACHINE_REV}/
